...
let  mathEnforcer = require('../mathEnforcers');

describe('mathEnforcer',() => {
    describe('addFive', () =>{
        it('Should return undifined whe parameter is not a number',()=> {
        ...
        it('Should return number plus 5 whe parameter is valid number',()=> {
    ...
    describe('sum', () =>{
        it('Should return undifined whe first parameter is not a number',()=> {
        ...
        it('Should return undifined whe second parameter is not a number',()=> {
        ...
        it('Should return the sum of both numbers when both whe parameter is valid number',()=> {
